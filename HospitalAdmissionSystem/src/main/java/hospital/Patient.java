...
/**
 * Base class for every person admitted to the hospital.
 * All fields are private (encapsulation) and only reachable through
 * getters/setters — this is what "information hiding" means in the rubric.
 */
public class Patient {
    ...
    /**
     * Prints the patient's details. Subclasses (like Inpatient) override this
     * and call super.displayDetails() to add their own extra fields.
     */
